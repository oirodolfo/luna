...
import trim from './native/compat/trim'
import root from './native/compat/root'
import html from './native/compat/html'
import isNum from './native/compat/isNum'
import contain from './native/compat/contain'
import toNum from './native/compat/toNum'
import detectOs from './native/compat/detectOs'
import loadImg from './native/compat/loadImg'
import isHidden from './native/compat/isHidden'
import durationFormat from './native/compat/durationFormat'
